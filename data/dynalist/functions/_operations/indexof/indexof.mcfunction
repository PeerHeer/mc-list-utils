...
execute if score $dynalist.compare.function dynalist.in matches 0 run function dynalist:_operations/contains/contains

# If a different function than the default was used, the list is iterated through.
execute unless score $dynalist.compare.function dynalist.in matches 0 run function dynalist:_internal/length
