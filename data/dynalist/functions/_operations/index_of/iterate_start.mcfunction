...
# Initialize iterator.
function dynalist:_operations/index_of/initialize_iterator

# Start the iteration if the list is not empty.
execute unless score $dynalist.iterator.length dynalist.var matches 0 run function dynalist:_operations/index_of/iterate
