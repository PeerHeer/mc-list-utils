...
#   Index: the first index of the slice, inclusive.
#   Index2: the last index of the slice, exclusive.
#> Returns:
...
execute if score #nbtlist.operation.has_index2 nbtlist.var matches 1 if score #nbtlist.operation.args.index2 nbtlist.var matches ..-1 run function nbtlist:operations/slice/convert_index2
...
tellraw @p ["",{"text":"Index:  "},{"score":{"name":"#nbtlist.operation.args.index","objective":"nbtlist.var"}}]
tellraw @p ["",{"text":"Index2: "},{"score":{"name":"#nbtlist.operation.args.index2","objective":"nbtlist.var"}}]