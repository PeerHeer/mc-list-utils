#> operations/max/check_max_element.mcfunction
...
# If no data was found yet, set the current element as the max element.
...
execute if score #nbtlist.operation.has_data nbtlist.var matches 1.. run function nbtlist:operations/max/get_max_element