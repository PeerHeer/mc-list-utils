...
execute store success score #nbtlist.generic.float_fractions.success nbtlist.var if score #nbtlist.generic.float_fractions.pos nbtlist.var matches 536870912..1073741823 run scoreboard players remove #nbtlist.generic.float_fractions.pos nbtlist.var 536870912
