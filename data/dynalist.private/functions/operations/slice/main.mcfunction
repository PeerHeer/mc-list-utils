...
execute unless score $dynalist.index.last dynalist.in = $dynalist.index.last dynalist.in run scoreboard players operation $dynalist.index.last dynalist.in = $dynalist.length dynalist.var

# Convert the first index from negative to positive if applicable.
scoreboard players operation $dynalist.iterator.index.first dynalist.var = $dynalist.length dynalist.var
...
scoreboard players operation $dynalist.iterator.index.last dynalist.var = $dynalist.length dynalist.var
