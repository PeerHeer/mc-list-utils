...
execute if score $dynalist.compare.result dynalist.var matches 0 run scoreboard players set $dynalist.success dynalist.out 1
execute if score $dynalist.compare.result dynalist.var matches 1 run scoreboard players set $dynalist.success dynalist.out 0
