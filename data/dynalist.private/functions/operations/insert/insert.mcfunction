...
execute unless score $dynalist.iterator.index dynalist.var matches ..0 unless score $dynalist.iterator.index dynalist.var >= $dynalist.length dynalist.var run function dynalist.private:operations/insert/iterate_start
...
execute if score $dynalist.iterator.index dynalist.var = $dynalist.length dynalist.var run function dynalist.private:operations/insert/copy_and_append
